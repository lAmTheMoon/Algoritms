 ...
 * создания строки с данным индексом.
 * Мы будем проходить по каждому индексу, проверять наличие строки в дереве, а далее записывать значения в массив.
 * Если последнее слово было найдено, то выходим из цикла.
 *
