 ...
 * ID посылки 95037375
 *
 * Чтобы найти наибольший префикс запакованных строк, сначала распаковываем каждую с использованием рекурсии.
 * После берем первую строку из получившегося списка и будем считать ее префиксом.
 * Далее проходимся в цикле по следующим срокам, постепенно уменьшая префикс пока ненайдем наибольший общий
 *
 * Временная сложность - O(N*M), где N - длина строк, а M - длина самой большой строки
...
public class A {
    ...
    public static void main(String[] args) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            System.out.println(getBiggestPrefix(unpackedStrings));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
